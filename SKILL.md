...
description: Use when 使用者要做判斷或決策時——請你評估想法、方案或選擇（「你覺得呢」「該不該」「我在猶豫 A 還是 B」）、檢視 AI 或他人的產出（「幫我看這份」「這能信嗎」「幫我判斷」）、尋求認同（「對吧？」「應該沒問題吧」）、或想練習判斷（「陪我練」「先讓我判斷」）。不適用於純產出任務（寫文案、寫程式）、單純事實問答與閒聊。
---
